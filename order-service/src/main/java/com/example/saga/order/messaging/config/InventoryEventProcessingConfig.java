...
@Slf4j
public class InventoryEventProcessingConfig {
    private final InventoryEventProcessor<OrderEvent> inventoryEventProcessor;
    ...
    public Function<Flux<Message<InventoryEvent>>,Flux<Message<OrderEvent>>> processor(){
        return flux->flux.map(MessageConverter::convertToRecord)
                ...
                .concatMap(r->this.inventoryEventProcessor.process(r.message())
