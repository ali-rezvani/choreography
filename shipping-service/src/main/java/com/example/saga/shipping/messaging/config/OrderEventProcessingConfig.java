package com.example.saga.shipping.messaging.config;
...
import com.example.saga.shipping.messaging.processor.OrderEventProcessorImpl;
...
public class OrderEventProcessingConfig {
    ...
    private final OrderEventProcessor<ShippingEvent> orderEventProcessor;

    @Bean
    public Function<Flux<Message<OrderEvent>>, Flux<Message<ShippingEvent>>> process() {
        return flux -> flux
